...
<html lang="ja">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb#">
    ...
    <!-- 各頁用 CSS-->
    <link rel="stylesheet" type="text/css" href="<?php echo $theme_uri; ?>/jukensei/assets/css/jukensei/index.css"><link rel="preconnect" href="https://fonts.googleapis.com">
      ...
      <article id="content">
        ...
        <section class="un_showcase">
          <div class="un_showcase_imgs"> 
            ...
            <div class="un_showcase_img"><img src="<?php echo $theme_uri; ?>/jukensei/assets/images/jukensei/showcase_img2.jpg" alt=""></div>
            <div class="un_showcase_img"><img src="<?php echo $theme_uri; ?>/jukensei/assets/images/jukensei/showcase_img3.jpg" alt=""></div>
        ...
        <section class="un_special"> 
          ...
          <div class="para para-slideup para-g2"><a class="un_special_item" href="/oc202403">
              <div class="un_special_item_img"><img src="<?php echo $theme_uri; ?>/jukensei/assets/images/jukensei/special_img1.jpg" alt="まっしろからはじめよう。OPEN CAMPUS">
                <p class="roboto"><span>11/30 SAT</span><br><span>10:00-13:00</span></p>
              </div>
              <div class="un_special_item_txt">OPEN CAMPUS<br><span>オープンキャンパス</span></div></a>
          </div>
          <div class="para para-slideup para-g2"><a class="un_special_item" href="<?php echo home_url(); ?>/support">
              ...
              <div class="un_special_item_txt">SPECIAL SUPPORT<br><span>ひとり暮らしのスタートを応援！</span></div></a>
          </div>
          <div class="para para-slideup para-g2"><a class="un_special_item" href="<?php echo home_url(); ?>/jukensei/specialcontents">
              ...
              <div class="un_special_item_txt">THE FUTURE OF STUDENTS<br><span>学生たちの未来宣誓</span></div></a>
          </div>
        </section>
        <section class="un_learnMore" style="">
          ...
          <div class="para para-slideup para-g4"><a class="un_learnMore_item" href="<?php echo home_url(); ?>/features/">
              ...
              <div class="un_learnMore_item_txt">WHAT’S KOKENDAI ?<br><span>学びの特色</span></div></a>
            <div class="un_learnMore_col"><a class="un_learnMore_item" href="<?php echo home_url(); ?>/features/rigaku/">
                ...
                <div class="un_learnMore_item_txt un_learnMore_item_txt--2">理学療法学専攻</div></a><a class="un_learnMore_item" href="<?php echo home_url(); ?>/features/sagyo/">
                <div class="un_learnMore_item_img"><img src="<?php echo $theme_uri; ?>/jukensei/assets/images/jukensei/learnmore_img3.jpg" alt=""></div>
                <div class="un_learnMore_item_txt un_learnMore_item_txt--2">作業療法学専攻</div></a></div>
          </div>
        </section>
        <section class="un_otherContents">
          ...
          <div class="para para-slideup para-g7"><a class="un_otherContents_item" href="<?php echo home_url(); ?>/jukensei/future">
              ...
              <div class="un_otherContents_item_txt">THE FUTURE OF THERAPISTS<br><span>学生×教員本音トーク</span></div></a></div>
          <div class="para para-slideup para-g7"><a class="un_otherContents_item" href="<?php echo home_url(); ?>/jukensei/campuslife">
              ...
              <div class="un_otherContents_item_txt">CAMPUS LIFE<br><span>先輩たちのキャンパスライフ</span></div></a></div>
          <div class="para para-slideup para-g7"><a class="un_otherContents_item" href="/admission">
              ...
              <div class="un_otherContents_item_txt">ADMISSIONS INFORMATION<br><span>入試情報</span></div></a></div>
        </section>
        ...
        <section class="un_others">
          ...
          <div class="para para-slideup para-g9"><a class="un_others_item" href="/career">
              <div class="un_others_item_img"><img src="<?php echo $theme_uri; ?>/jukensei/assets/images/jukensei/others_img1.jpg" alt="キャリア・就職支援"></div></a></div>
          <div class="para para-slideup para-g9"><a class="un_others_item" href="/expenses">
              <div class="un_others_item_img"><img src="<?php echo $theme_uri; ?>/jukensei/assets/images/jukensei/others_img2.jpg" alt="学費・奨学金"></div></a></div>
          <div class="para para-slideup para-g9"><a class="un_others_item" href="/access">
              <div class="un_others_item_img"><img src="<?php echo $theme_uri; ?>/jukensei/assets/images/jukensei/others_img3.jpg" alt="アクセス"></div></a></div>
        </section>
