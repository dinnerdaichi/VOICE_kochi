...
<head>
    ...
    <a href="https://docs.google.com/forms/d/e/1FAIpQLSfDbsQUJ7vLDfjdX8Y6t1qe-3Aqn2Qi8RNZTtWkfMZ-FROa-Q/viewform" class="fixed-banner" target="_blank">
        <img src="<?php echo site_url();?>/wp-content/themes/ko-ken-k3/oc/assets/images/fixed_banner.jpg" alt="LINE登録でイベント情報をお届け！">
    </a>
    ...
    <div class="fixed-nav">
        <div class="fixed-nav__inner">
            ...
            <div class="fixed-nav__title">
                <img src="<?php echo site_url();?>/wp-content/themes/ko-ken-k3/oc/assets/images/fixed_nav_title.png" alt="まっしろからはじめよう。">
            </div>
...
-->
    ...
    <main>
        <div class="fv">
            <div class="fv__inner">
                <p class="time">今年度のオープンキャンパスは<br>終了しました。</p>
<!--
...
-->
        ...
        <div class="sec1">
            <h2 class="common__title">MESSAGE</h2>
            <p class="common__subtitle">高校生のあなたへ</p>
        ...
        <div class="sec2" id="event">
            <h2 class="common__title">MAIN EVENT</h2>
            <p class="common__subtitle">今回の推しイベント</p>
            <p class="sec2__text">楽しみながら学べるイベントを開催！<br>何回でも遊びに来てください！</p>
            <div class="sec2__item sec2__item--first fadeinElem toUp">
                <img src="<?php echo site_url();?>/wp-content/themes/ko-ken-k3/oc/assets/images/sec2_img0.png" alt="Coming Soon">
            </div>
<!--
            <div class="sec2__item sec2__item--first fadeinElem toUp">
                <img src="<?php echo site_url();?>/wp-content/themes/ko-ken-k3/oc/assets/images/sec2_img1_202501.png" alt="うらしま太郎で高齢者擬似体験 60年後の自分を体験!?">
            </div>
            <div class="sec2__item fadeinElem toUp">
                <img src="<?php echo site_url();?>/wp-content/themes/ko-ken-k3/oc/assets/images/sec2_img2_202501.png" alt="ぐるっと一周キャンパスツアー 高健大ってぶっちゃけどんな大学なんですか？">
            </div>
            <div class="sec2__item fadeinElem toUp">
                <img src="<?php echo site_url();?>/wp-content/themes/ko-ken-k3/oc/assets/images/sec2_img3_202501.png" alt="保護者のための説明会開催！">
            </div>
-->
        </div>

        <div class="sec3">
            <h2 class="common__title">PROGRAM</h2>
            <p class="common__subtitle">通常プログラム</p>
            ...
            <div class="sec3__box fadeinElem toUp">
                <div class="sec3__box__item">
                    <img src="<?php echo site_url();?>/wp-content/themes/ko-ken-k3/oc/assets/images/sec3_img1.png" alt="学校説明会">
                    <p class="item__title">学校説明会</p>
                </div>
                <div class="sec3__box__item">
                    <img src="<?php echo site_url();?>/wp-content/themes/ko-ken-k3/oc/assets/images/sec3_img2.png" alt="入試説明会">
                    <p class="item__title">入試説明会</p>
                </div>
                <div class="sec3__box__item">
                    <img src="<?php echo site_url();?>/wp-content/themes/ko-ken-k3/oc/assets/images/sec3_img3.png" alt="個別相談会">
                    <p class="item__title">個別相談会</p>
                </div>
                <div class="sec3__box__item">
                    <img src="<?php echo site_url();?>/wp-content/themes/ko-ken-k3/oc/assets/images/sec3_img4.png" alt="展示・視聴ブース">
                    <p class="item__title">展示・視聴ブース</p>
                </div>
            </div>
        ...
        <div class="sec4">
            <h2 class="common__title">TIMETABLE</h2>
            <p class="common__subtitle">タイムテーブル</p>
        ...
        <div class="sec5">
            <h2 class="common__title">PRESENTS</h2>
            <p class="common__subtitle">参加者限定プレゼント</p>
        ...
        <div class="sec6" id="access">
            <h2 class="common__title">ACCESS</h2>
            <p class="common__subtitle">アクセス</p>
            ...
            <div class="sec6__content fadeinElem toUp">
                <p class="sec6__bg-text sec6__bg-text2">お車でお越しの方</p>
                <p class="sec6__text">○はりまや橋より約10分<br>○JR高知駅より約10分<br>○高知インターより約5分<br>○高知中央インターより約2分<br>○高知龍馬空港より約20分<br><br>※無料駐車場完備（約150台）</p>
            </div>
        </div>

        <div class="sec7" id="entry">
            <h2 class="common__title">ENTRY</h2>
            <p class="common__subtitle">お申し込み</p>
        ...
        <div class="sec8" id="schedule">
            <h2 class="common__title">NEXT</h2>
            <p class="common__subtitle">OPEN CAMPUSスケジュール</p>
            <p class="sec8__title">2024 SCHEDULE</p>
            ...
            <div class="sec8__box" style="position: relative;">
                ...
                <p style="width: 100%;font-size: 18px;font-weight: 600;text-align: center;line-height: 1.5;letter-spacing: 0.05em;position: absolute;top: 50%;right: 50%;transform: translate(50%,-50%)">&nbsp;今年度の全日程は終了しました。<br>2025年初回は4/25に開催します！</p>
            </div>
